 ...
 */
export const CE_DI = {
  CURL_CREATOR: 'di-symbol-key-logging-controller-curl-creator',
  MAEUM_LOGGERS: 'di-symbol-key-logging-controller-maeum-loggers',
  PINO_LOGGERS: 'di-symbol-key-logging-controller-pino-loggers',
  REQUEST_LOGGER: 'di-symbol-key-logging-controller-request-logger',
  WINSTON_LOGGERS: 'di-symbol-key-logging-controller-winston-loggers',
} as const;
