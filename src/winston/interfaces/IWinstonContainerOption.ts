...
export type TWinstonContainerBootstrapOptions<TASYNC extends boolean> = Record<
  /**
...
export interface IWinstonContainerOptions {
  getEnableDebugMessage: () => boolean;
  loggers: Record<string, IWinstonMaeumLogger>;
}
